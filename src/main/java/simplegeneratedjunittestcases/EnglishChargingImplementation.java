...
/** An implementation for the charging interface for an English Charge.
 * 
 *  In this case, the implementations do have concrete implementation,
 *  as opposed to default interface implementattion  
 * 
 * @author Rob
 *
 */
public class EnglishChargingImplementation implements chargingInterface {
	 ...
	 */
	public EnglishChargingImplementation(String inReference, double inchargeAmount) {
	...
	public String getChargeDetails() {
		String chargeDetails = this.chargeReference + " In Pounds " + this.chargeAmount;
